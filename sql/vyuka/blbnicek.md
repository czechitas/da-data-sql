...
- Nemáš Czechita účet, nebo dokonce vůbec nejsi Czechita? 😱 Nevadí, stačí si založit account v [Keboola](https://connection.north-europe.azure.keboola.com/wizard) a stáhnout si [tabulku teror](https://docs.google.com/uc?export=download&id=1y4G90EpXRB-lgCU00VBfofUGyNu6zCFg&confirm=true), vytvořit ve storage bucket a nahrát do něj. Pak už stačí si založit snowflake workspace a dál je všechno stejné jako tady.
